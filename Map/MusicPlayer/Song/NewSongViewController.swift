...
""")
  ...
  func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
    ...
    let song = musicArray[indexPath.row]
    
    cell.songLabel.text = song.song
    cell.singerLabel.text = song.singer
    cell.singerImageView.image = UIImage(named: song.imangeArray)
    return cell
  }
  ...
  func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
    ...
    var song = musicArray[indexPath.row]
    let vc = SongDetilViewController()
    vc.songTitle = song.song
    vc.songText = song.lyric
    vc.singerImageTitle = song.imangeArray
